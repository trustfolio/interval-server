...
{"nodes":[{"id":"auth_session_validatetoken","label":"ValidateToken","file_type":"code|document|paper|image|rationale|concept","source_file":"src/auth/session.py","source_location":null,"source_url":null,"captured_at":null,"author":null,"contributor":null}],"edges":[{"source":"auth_session_validatetoken","target":"utils_helpers_parse_url","relation":"calls|implements|references|cites|conceptually_related_to|shares_data_with|semantically_similar_to|rationale_for","confidence":"EXTRACTED|INFERRED|AMBIGUOUS","confidence_score":1.0,"source_file":"src/auth/session.py","source_location":null,"weight":1.0}],"hyperedges":[{"id":"snake_case_id","label":"Human Readable Label","nodes":["auth_session_validatetoken","utils_helpers_parse_url"],"relation":"participate_in|implement|form","confidence":"EXTRACTED|INFERRED","confidence_score":0.75,"source_file":"src/auth/session.py"}],"input_tokens":0,"output_tokens":0}
